<h1>'Hello World', I'm Areena! <br/> <h2> Computer Science and Games Development Portfolio</h2>
...
- **ASCII Alphabet Sound Display** — C++ console app rendering ASCII art with sound  
- **Snake Game** — Classic Snake implemented in Python using turtle graphics  
